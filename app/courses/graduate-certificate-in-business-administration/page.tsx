...
export default function GraduateCertificateInBusinessAdministrationPage() {
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [])
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-4xl font-light md:text-6xl">Graduate Certificate in Business Administration</h1>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl space-y-8">
            <p className="text-lg leading-relaxed text-gray-700">
              The Graduate Certificate in Business Administration at AISC provides foundational business and leadership
              skills and serves as a pathway to the MBA.
            </p>
            <p className="text-lg leading-relaxed text-gray-700">
              The Graduate Certificate in Business Administration (MBA) course at the Adelaide Institute of Sciences
              (AISC) is designed to equip students with foundation of business knowledge and leadership skills necessary
              for success in diverse organizational settings. The course is a nested qualification while perusing MBA.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-8 text-3xl font-light text-[#2a9d8f]">Course Duration: Six months / One Year</h2>
            <div className="space-y-6">
              ...
              <div className="rounded-lg bg-white p-6 shadow-sm">
                ...
                <ul className="space-y-2 list-disc text-gray-700">
                  <li>Any units from Foundation Units and Core Units – Four (4)</li>
                </ul>
              </div>
